...
import BatchEntryDateDetail from './pages/admin/BatchEntryDateDetail';
...
import EntryGroupDetail from './pages/driver/EntryGroupDetail';
      ...
      <Routes>
        ...
        {user ? (
          <>
            ...
            <Route path="/admin/batch-entry/:date" element={<BatchEntryDateDetail />} />
            ...
            <Route path="/admin/driver/entries/:date/:vehicleNumber" element={<EntryGroupDetail />} />
