...
export default function BrandLogo({ size = 52, style }) {
  if (Platform.OS === 'web') {
    return (
      <div style={{ width: size, height: size, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, ...style }}>
        ...
        >
          <defs>
            <linearGradient id="clientGreenGradWeb" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#2e7d52" />
              <stop offset="100%" stopColor="#1b4d32" />
            </linearGradient>
            <linearGradient id="mulberryGoldGradWeb" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#fcd34d" />
              <stop offset="100%" stopColor="#f59e0b" />
            </linearGradient>
          </defs>
          <rect width="128" height="128" rx="34" fill="url(#clientGreenGradWeb)" />
          <svg x="16" y="16" width="96" height="96" viewBox="170 170 376 376">
            <path d={PATH_DATA} fill="url(#mulberryGoldGradWeb)" />
          </svg>
        </svg>
      </div>
    );
  ...
  // Native iOS / Android rendering using react-native-svg
  return (
    <View style={[{ width: size, height: size }, style]}>
      <Svg width={size} height={size} viewBox="0 0 128 128" fill="none">
        <Defs>
          <LinearGradient id="clientGreenGradRN" x1="0%" y1="0%" x2="100%" y2="100%">
            <Stop offset="0%" stopColor="#2e7d52" />
            <Stop offset="100%" stopColor="#1b4d32" />
          </LinearGradient>
          <LinearGradient id="mulberryGoldGradRN" x1="0%" y1="0%" x2="100%" y2="100%">
            <Stop offset="0%" stopColor="#fcd34d" />
            <Stop offset="100%" stopColor="#f59e0b" />
          </LinearGradient>
        </Defs>

        <Rect width="128" height="128" rx="34" fill="url(#clientGreenGradRN)" />

        <G transform="translate(16, 16) scale(0.255) translate(-170, -170)">
          <Path d={PATH_DATA} fill="url(#mulberryGoldGradRN)" />
        </G>
      </Svg>
    </View>
  );
