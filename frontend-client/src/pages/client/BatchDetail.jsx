    ...
    <AppShell title="Batch Detail" backPath="/batch-history">
      ...
      {vr && (
        <div className={styles.rentalCard}>
          <p className={styles.rentalTitle}>Rental total value</p>
          <div className={styles.valueRow}>
          ...
          {rentalOnly > 0 && (
            <div className={styles.valueRow}>
              <span>
                Rental: {good} kg × {vr.ratePerKg != null ? formatINR(vr.ratePerKg) : '—'}
              </span>
              <span style={{ color: '#8b6914', fontWeight: 600 }}>−{formatINR(rentalOnly)}</span>
            </div>
          )}
          {lotAmt > 0 && (
            <div className={styles.valueRow}>
              <span>
                Lot: {batch.lotQty || 0} × {formatINR(batch.lotPrice || 0)}
              </span>
              <span style={{ color: '#8b6914', fontWeight: 600 }}>−{formatINR(lotAmt)}</span>
            </div>
          )}
          <div className={styles.rentalFinal}>
            <strong>Rental total value</strong>
            <strong style={{ color: '#8b6914' }}>−{formatINR(rentalTotal)}</strong>
          </div>
          <div className={styles.rentalFinal}>
