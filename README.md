...
| Driver | Netlify | https://tracknow-driver.netlify.app |
| API | Netlify (Functions) | https://tracknow-backend.netlify.app |

All components are hosted on Netlify; point `VITE_API_URL` at the Netlify API. Guides: [DEPLOY_NETLIFY.md](./DEPLOY_NETLIFY.md), [DEPLOY_NETLIFY_API.md](./DEPLOY_NETLIFY_API.md)
...
│   ├── src/
│   └── netlify.toml
├── frontend-driver/           # Driver app (Vite + React)
│   ├── src/
│   └── netlify.toml
├── DEPLOY_NETLIFY.md          # Three frontend sites on Netlify
